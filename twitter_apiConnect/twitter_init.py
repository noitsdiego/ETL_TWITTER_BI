...
twitter_etl_load_helper.guardarBaseDeDatosAWS(dfTweets,"tweets")
twitter_etl_load_helper.guardarBaseDeDatosAWS(dfTweetsRT,"tweets_RT")
twitter_etl_load_helper.guardarBaseDeDatosAWS(dfTweetsDeVerificados,"tweets_De_Verificados")
twitter_etl_load_helper.guardarBaseDeDatosAWS(dfTweetsDeNoVerificados,"tweets_De_No_Verificados")
twitter_etl_load_helper.guardarBaseDeDatosAWS(dfTweetsOriginal,"tweets_Originales")